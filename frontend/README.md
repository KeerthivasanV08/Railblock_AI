...
conflict detection, resource optimisation and self-healing rescheduling on a synthetic **New Delhi –
Kanpur** corridor. This repository contains the **frontend only** — a fully functional React/TypeScript
